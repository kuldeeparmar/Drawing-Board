...
const Menu = () => {
    ...
    const handleActionMenuClick = (itemName) => {
    ...
    return (
        <div className={styles.menuContainer}> 
            ...
            <div className={styles.iconWrapper} onClick={() => handleActionMenuClick(MENU_ITEMS.UNDO)}>
                <FontAwesomeIcon icon={faRotateLeft} className={styles.icon}/>
            </div>
            <div className={styles.iconWrapper} onClick={() => handleActionMenuClick(MENU_ITEMS.REDO)}>
                <FontAwesomeIcon icon={faRotateRight} className={styles.icon}/>
            </div>
            <div className={styles.iconWrapper} onClick={() => handleActionMenuClick(MENU_ITEMS.DOWNLOAD)}>
